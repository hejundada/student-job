<template>
  <div class="student-box" v-bind:style="{height:myHeight}">
    <div class="box-infor">
      <div class="header-text">系统公告列表</div>
      <div class="issue"><el-button class="allsubbtn" @click="iccue_button">发布公告</el-button><div></div></div>
      <div class="table-box">
        <table id="tableSort" style="table-layout:fixed;">
          ...
          <tbody class="table-lists">
            ...
            >
              ...
              <td class="sequence">
                <a class="amend-infor" @click="amend(item.id,item.content)">修改</a>
        ...
        <div class="sub-popup-con">
          ...
          <div class="amend-infor2">
            <div class="amend-infor-list">
              <label>公告</label>
              <el-input class="el-input2" v-model="name" placeholder="请输入公告"></el-input>
            </div>
          </div>
      ...
      <div class="establish-sub-popup" v-show="issue_show">
        <div class="sub-popup-con">
          ...
          <div class="amend-infor2">
            <div class="amend-infor-list">
              <label>公告</label>
              <el-input class="el-input2" v-model="notice" placeholder="请输入公告"></el-input>
            </div>
          </div>
          <div class="subpopup-twobtn">
...
export default {
  ...
  methods: {
    ...
    Notices(){
      axios({
          method: "post",
          url: "http://114.115.147.52:7076/systemPub/getSystemPubs",
          headers: {
    ...
    confirm() {
      if(this.name == ''){
        ...
        axios({
          method: "post",
          url: "http://114.115.147.52:7076/systemPub/updateSystemPub"+"?content="+this.name+"&id="+getCookie("notId"),
          headers: {
            "Content-Type": "application/json;charset=UTF-8"
          }
        })
    ...
    del(i){
      axios({
          method: "post",
          url: "http://114.115.147.52:7076/systemPub/deleteSystemPub"+"?id="+i,
          headers: {
            "Content-Type": "application/json;charset=UTF-8"
          }
        })
    ...
    confirm2() {
      if(this.notice == ''){
        ...
        axios({
          method: "post",
          url: "http://114.115.147.52:7076/systemPub/addSystemPub"+"?content="+this.notice,
          headers: {
            "Content-Type": "application/json;charset=UTF-8"
          }
        })
