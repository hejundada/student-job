     ...
     <div class="Resume">
           ...
           <div class="Resume-content">
                <div class="Resume-content-form">
                       ...
                       <div class="form-text">
                            <label>宝贵意见:</label>
                            <textarea type="text" v-model="modifydata.idea"></textarea>
                       </div>
    ...
    export default {
        ...
        methods: {
            ...
            begindata(){
                axios({
                    method:'post',
                    url:'http://114.115.147.52:7076/message/addMessage'+'?username='+getCookie("name")+'&content='+this.modifydata.idea,
